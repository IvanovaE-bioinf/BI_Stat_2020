...
Все операции по подбору и оценке модели были проведены с использованием  R версии 3.6.3. Для расчетов использовались следующие пакеты (которые будут установлены при выполнении кода ниже вручную перед компиляцией):
